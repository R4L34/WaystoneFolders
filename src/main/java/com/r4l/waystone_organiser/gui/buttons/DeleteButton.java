...
public class DeleteButton extends GuiButton{
	...
	private static final ResourceLocation BUTTON = new ResourceLocation(Reference.MODID, "buttons/trash.png");
	private static final ResourceLocation BUTTON1 = new ResourceLocation(Reference.MODID, "buttons/trash1.png");
	...
	public DeleteButton(int buttonId, int x, int y, String folder) {
		super(buttonId, x, y, 20, 20, "D");
